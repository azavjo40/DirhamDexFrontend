// Generated by @wagmi/cli@0.1.15 on 05.10.2023 at 17:59:20
import {
  getContract,
  GetContractArgs,
  readContract,
...
export const dirhamABI = [
  {
    ...
    type: 'constructor',
    inputs: [
      { name: 'exchangeRate', internalType: 'address', type: 'address' },
    ],
  },
  {
    type: 'event',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link dirhamABI}__ and `functionName` set to `"exchangeRates"`.
 */
export function useDirhamExchangeRates<
  TSelectData = ReadContractResult<typeof dirhamABI, 'exchangeRates'>,
>(
  config: Omit<
    UseContractReadConfig<typeof dirhamABI, 'exchangeRates', TSelectData>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof dirhamABI, 'exchangeRates', TSelectData>)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link dirhamABI}__ and `functionName` set to `"buyTokens"`.
 */
export function useDirhamBuyTokens<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof dirhamABI, 'buyTokens'>['abi'],
        'buyTokens'
      > & { functionName?: 'buyTokens' }
    : UseContractWriteConfig<TMode, typeof dirhamABI, 'buyTokens'> & {
        abi?: never
        functionName?: 'buyTokens'
      } = {} as any,
) {
  return useContractWrite<TMode, typeof dirhamABI, 'buyTokens'>({
    abi: dirhamABI,
    functionName: 'buyTokens',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link dirhamABI}__ and `functionName` set to `"withdraw"`.
 */
export function useDirhamWithdraw<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof dirhamABI, 'withdraw'>['abi'],
        'withdraw'
      > & { functionName?: 'withdraw' }
    : UseContractWriteConfig<TMode, typeof dirhamABI, 'withdraw'> & {
        abi?: never
        functionName?: 'withdraw'
      } = {} as any,
) {
  return useContractWrite<TMode, typeof dirhamABI, 'withdraw'>({
    abi: dirhamABI,
    functionName: 'withdraw',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link dirhamABI}__ and `functionName` set to `"buyTokens"`.
 */
export function usePrepareDirhamBuyTokens(
  config: Omit<
    UsePrepareContractWriteConfig<typeof dirhamABI, 'buyTokens'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'buyTokens',
    ...config,
  } as UsePrepareContractWriteConfig<typeof dirhamABI, 'buyTokens'>)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link dirhamABI}__ and `functionName` set to `"withdraw"`.
 */
export function usePrepareDirhamWithdraw(
  config: Omit<
    UsePrepareContractWriteConfig<typeof dirhamABI, 'withdraw'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'withdraw',
    ...config,
  } as UsePrepareContractWriteConfig<typeof dirhamABI, 'withdraw'>)
}
